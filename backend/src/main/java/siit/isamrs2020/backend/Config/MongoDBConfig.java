...
public class MongoDBConfig {
  ...
  CommandLineRunner commandLineRunner(DoctorRepository doctorRepository, NurseRepository nurseRepository, ClinicAdminRepository clinicAdminRepository, ClinicRepository clinicRepository) {
    return strings -> {
      // doctorRepository.save(new Doctor(1, "Bojan", "Cakic", 40, "adresa1", 10, MedicalSpecialty.Gynecology));
      // doctorRepository.save(new Doctor(2, "Milan", "Milic", 35, "adresa2", 5, MedicalSpecialty.Radiology));
      // doctorRepository.save(new Doctor(3, "Nikola", "Nikolic", 41, "adresa3", 9, MedicalSpecialty.Oncology));
      
      // nurseRepository.save(new Nurse(1, "Marija", "Maric", 39, "adresa10", 12));
      // nurseRepository.save(new Nurse(2, "Ana", "Nikolic", 25, "adresa123", 2));
